/// <summary>
/// Asym frustum. (Adapted from https://github.com/Emerix/AsymFrustum)
...
public class VirtualWindow : MonoBehaviour {
    ...
    /// <summary>
    /// Screen/window to virtual world width (in units)
    /// </summary>
    public float width;
    /// <summary>
    /// Screen/window to virtual world height (in units)
    /// </summary>
    public float height;
    /// <summary>
    /// The maximum height the camera can have (up axis in local coordinates from  the virtualWindow) (in units)
    /// </summary>
    ...
    public void SetAsymmetricFrustum(Camera cam, Vector3 pos, float nearDist) {
        ...
        cam.projectionMatrix = PerspectiveOffCenter(
            nearLeft, nearRight, nearBottom, nearTop, cam.nearClipPlane, cam.farClipPlane);
    }
